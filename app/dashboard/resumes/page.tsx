...
import { Plus, Trash2, Edit2, FileText, ArrowLeft } from "lucide-react";
import Link from "next/link";
import { useRouter } from "next/navigation";
// import { formatDate } from "@/lib/utils";
import { LayoutDashboard, Files, FileType } from "lucide-react";
...
export default function ResumesPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
            {/* Header / Sub-nav - Replicated for consistency, components/layout/dashboard-header would be better dry but keeping simple */}
            <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
                <div className="container mx-auto px-6 py-8">
                    ...
                    <nav className="flex items-center gap-6 mt-8 border-b border-transparent">
                        ...
                        <Link href="/dashboard/resumes" className="pb-3 border-b-2 border-primary font-medium text-primary flex items-center gap-2">
                            <Files className="w-4 h-4" />
                            My Resumes
                        </Link>
                        <Link href="/dashboard/cover-letters" className="pb-3 border-b-2 border-transparent hover:border-slate-300 text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2">
